  ...
  if (index < 4) {
    ...
    for (int j = 0; j < 15; j++) {
      for (int k = 0; k < 5; k++) {
        ...
        if (k < 5) {
          EEPROM.write(offset + 150 + ((5 * j) + k), auduinoADSR[j][k]);
        }
      }
    }
  }
  ...
  if (index < 4) {
    for (int j = 0; j < 15; j++) {
      for (int k = 0; k < 5; k++) {
        ...
        if (k < 5) {
          auduinoADSR[j][k] = EEPROM.read(offset + 150 + ((5 * j) + k));
        }      
      }
    }
  } else {
    for (int j = 0; j < 15; j++) {
      for (int k = 0; k < 5; k++) {
        ...
        if (k < 5) {
          auduinoADSR[j][k] = pgm_read_word_near(flashPpreset + 150 + (offset + ((5 * j) + k)));
        } 
      }
    }
  }
